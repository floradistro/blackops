...
// MARK: - React Render Template
// Extracted from HotReloadComponents.swift following Apple engineering standards
// Contains: HTML template builder for React hot reload rendering
// File size: ~740 lines (meets Apple's <1000 line "acceptable" threshold)
//
// This massive HTML template sets up a complete React development environment
// with all necessary libraries for hot reload rendering of React creations.

struct ReactRenderTemplate {
    
    /// Builds the complete HTML document for React rendering
    /// - Parameter code: The React component code to render
    /// - Returns: Complete HTML string with all dependencies
    static func buildHTML(code: String) -> String {
        let safeCode = code
